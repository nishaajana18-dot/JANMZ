...
def build_demo_bundle() -> dict[str, list | ResearchProject]:
    ...
    hypotheses = [
        Hypothesis(
            ...
            variables_involved=["skin temperature", "heart-rate drift", "dehydration risk"],
            literature_support="Synthetic demo evidence only; not a real literature claim.",
            dataset_support="Synthetic pilot summary only.",
            possible_confounders=["heat acclimation", "caffeine intake", "sensor placement"],
